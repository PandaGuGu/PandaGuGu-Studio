...
export const PROVIDERS: ProviderDef[] = [
  ...
  },
  {
    ...
    keyHint: 'paste DeepSeek key',
    keyUrl: 'https://platform.deepseek.com/api_keys',
    keyUrlLabel: 'DeepSeek',
  ...
  },
  {
    ...
    models: [
      { id: 'moonshot-v1-32k', label: 'Moonshot v1 32K', vision: true },
      { id: 'moonshot-v1-8k', label: 'Moonshot v1 8K', vision: true },
      { id: 'kimi-k2-0711-preview', label: 'Kimi K2 0711 Preview' },
    ],
    keyHint: 'paste Moonshot key',
    keyUrl: 'https://platform.moonshot.cn/console/api-keys',
    keyUrlLabel: 'Moonshot',
    storageKey: 'moonshot_key',
  },
  {
    id: 'qwen',
    name: '通义千问',
    ...
    models: [
      { id: 'qwen-vl-plus', label: 'Qwen-VL-Plus (视觉)', vision: true },
      { id: 'qwen-plus', label: 'Qwen-Plus' },
      { id: 'qwen-max', label: 'Qwen-Max' },
    ],
    keyHint: 'paste 阿里云百炼 key',
  ...
  },
  {
    ...
    models: [
      { id: 'doubao-1.5-pro-32k-250115', label: 'Doubao 1.5 Pro 32K', vision: true },
      { id: 'doubao-1.5-lite-32k-250115', label: 'Doubao 1.5 Lite 32K', vision: true },
      { id: 'doubao-seed-1-6-250615', label: 'Doubao Seed 1.6' },
    ],
    keyHint: 'paste 火山方舟 key',
